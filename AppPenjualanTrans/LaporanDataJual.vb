...
Public Class LaporanDataJual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualanTrans.LaporanDataJual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDataJual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDataJual = New LaporanDataJual()
        rpt.Site = Me.Site
        Return rpt
    End Function
