...
Public Class LaporanDataAdmin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualanTrans.LaporanDataAdmin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDataAdmin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDataAdmin = New LaporanDataAdmin()
        rpt.Site = Me.Site
        Return rpt
    End Function
