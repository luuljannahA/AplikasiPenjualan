...
Public Class FormMasterAdmin
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Else
                Call koneksi()
                Dim SimpanData As String = "Insert into tbl_admin values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "')"
    ...
    Private Sub TextBox2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox2.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Else
                ...
                TextBox4.Text = Rd.Item("LevelAdmin")
            End If
        End If
    End Sub
    ...
    Private Sub TextBox1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox1.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            If Rd.HasRows Then
                ...
                TextBox4.Text = Rd.Item("level_admin")
            Else
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            ...
            Else
                Call koneksi()
                Dim EditData As String = "Update tbl_admin set nama_admin='" & TextBox2.Text & "',password_admin= '" & TextBox3.Text & "',level_admin ='" & TextBox4.Text & "' where kode_admin= '" & TextBox1.Text & "'"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Call koneksi()
        Da = New OleDbDataAdapter("select * from tbl_admin where kode_admin like '" & TextBox5.Text & "%'", Conn)
        Ds = New DataSet
        Dim data As String
        data = Da.Fill(Ds)
